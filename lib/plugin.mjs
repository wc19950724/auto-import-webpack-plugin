...
var setOptions = (params) => __async(void 0, null, function* () {
  ...
  if (!Array.isArray(options.ignore)) {
    ...
    if (fs.existsSync(projectIgnorePath)) {
      const ignoreContext = fs.readFileSync(projectIgnorePath).toString().replace(/\/$/gm, "");
...
var generateAutoImportFile = (vueComponents) => __async(void 0, null, function* () {
  ...
  fs2.writeFileSync(outputPath, fileContent);
  ...
  apply(compiler) {
    return __async(this, null, function* () {
      ...
      if (compiler.options.mode === "development" || compiler.options.optimization.nodeEnv === "development") {
        ...
        compiler.hooks.beforeRun.tap(_AutoImportPlugin.name, () => __async(this, null, function* () {
          try {
